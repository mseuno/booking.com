...
CREATE TABLE `black_list` (
  ...
  CONSTRAINT `FK_black_list_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `booking` (
  ...
  CONSTRAINT `FK_booking_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `booking` VALUES (2,1,3,'2014-04-03','2014-04-09',19600,1,'2014-03-23 17:09:34'),(3,2,3,'2014-04-15','2014-04-16',1200,0,'2014-04-04 02:03:23'),(4,1,3,'2014-04-15','2014-04-19',7750,1,'2014-03-23 17:09:59'),(8,2,7,'2014-04-05','2014-04-06',18802,0,'2014-04-04 03:08:35'),(9,2,6,'2014-04-05','2014-04-06',1650,0,'2014-04-04 04:45:33');
...
CREATE TABLE `booking_room` (
  ...
  CONSTRAINT `FK_booking_room_room_id` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_booking_room_booking_id` FOREIGN KEY (`booking_id`) REFERENCES `booking` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_booking_room_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `booking_room` VALUES (2,2,5,3,1,8400),(3,2,6,3,1,11200),(4,3,3,3,1,1200),(5,4,3,3,1,3000),(6,4,4,3,1,4750),(7,8,22,7,7,2686),(8,9,18,6,5,330);
...
CREATE TABLE `city` (
  ...
  KEY `FK_city_region_id_idx` (`region_id`,`locale_id`),
  KEY `FK_city_country_id_idx` (`country_id`,`locale_id`),
  CONSTRAINT `FK_city_region_id` FOREIGN KEY (`region_id`, `locale_id`) REFERENCES `region` (`id`, `locale_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_city_country_id` FOREIGN KEY (`country_id`, `locale_id`) REFERENCES `country` (`id`, `locale_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_city_locale_id` FOREIGN KEY (`locale_id`) REFERENCES `locale` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `country` (
  ...
  CONSTRAINT `FK_country_locale_id` FOREIGN KEY (`locale_id`) REFERENCES `locale` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `favorite` (
  ...
  CONSTRAINT `FK_favorite_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hotel` VALUES (3,'70, 79056','україна',0,245,13,1,2,'\0',NULL,'2014-04-06 06:56:51',NULL,NULL,0),(4,'4, 79008',NULL,0,245,13,1,3,'\0',NULL,'2014-04-06 06:56:53',NULL,NULL,0),(5,'1, 79000',NULL,0,245,13,1,4,'\0',NULL,'2014-04-06 06:56:55',NULL,NULL,0),(6,'43Б, 82660',NULL,5,245,13,3,5,'\0',NULL,'2014-04-06 07:40:05',NULL,NULL,0),(7,'43, 75009','null',0,83,31,10,6,'\0',NULL,'2014-04-06 06:57:07',NULL,NULL,0),(8,'3, 79000',NULL,0,245,13,1,2,'\0',NULL,'2014-04-06 07:37:32',NULL,NULL,0),(9,'2, 79000',NULL,0,245,13,1,5,'\0',NULL,'2014-04-06 07:38:19',NULL,NULL,0),(10,NULL,NULL,0,245,13,1,6,'\0',NULL,'2014-04-06 07:38:09',NULL,NULL,0),(11,NULL,NULL,0,245,13,1,6,'\0',NULL,'2014-04-06 07:38:06',NULL,NULL,0),(12,'6, 79000',NULL,0,245,13,1,8,'',NULL,'2014-04-06 07:37:56',NULL,NULL,0),(13,NULL,NULL,0,245,13,1,4,'\0',NULL,'2014-04-06 07:37:59',NULL,NULL,0),(14,NULL,NULL,0,245,13,1,5,'\0',NULL,'2014-04-06 07:38:02',NULL,NULL,0),(15,NULL,NULL,0,245,13,3,3,'\0',NULL,'2014-04-06 07:37:46',NULL,NULL,0);
...
CREATE TABLE `hotel_gallery` (
  ...
  CONSTRAINT `FK_hotel_gallery_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `hotel_info` (
  ...
  CONSTRAINT `FK_hotel_info_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_hotel_info_locale_id` FOREIGN KEY (`locale_id`) REFERENCES `locale` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hotel_service` (
  ...
  CONSTRAINT `FK_hotel_service_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_hotel_service_service_id` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `hotel_service` VALUES (6,3,9),(7,8,1),(8,8,2),(9,8,9),(10,9,1),(11,9,3),(12,9,2),(13,10,1),(14,10,6),(15,10,5),(16,11,4),(17,11,5),(18,11,7),(19,12,5),(20,12,4),(21,12,7),(22,13,5),(23,13,2),(24,13,7),(39,7,1),(40,7,3),(41,7,5);
...
CREATE TABLE `manager` (
  ...
  CONSTRAINT `FK_manager_admin_id` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_manager_hotel` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `manager` VALUES (2,'Karina','Bella','bela@yahoo.com',1,'2014-04-06 07:53:53','02a679774c0158d5a6efd9f07b9ad76d','095933744','2014-02-01',3),(15,'Oleksandr','Kolchenko','ol_kol@ukr.net',1,'2014-04-06 07:53:55','1e47a90fcc9c5b35508a4cda5900b081','234567','2014-03-19',4),(16,'Anton','Davydjuk','davydjuk@gmail.com',1,'2014-04-06 07:53:56','1e27af962f610ccd0f97161e72c6c2a4','234567','2014-03-19',5),(17,'Maks','Ivschyn','ivschyn@ukr.net',1,'2014-04-06 07:53:58','21dc62ca4082398be2331da5640913be','234557','2014-03-19',6),(18,'Mykola','Trush','trusch@gmail.com',NULL,'2014-04-06 07:55:44','a9f47c4c9f1a31b868c48e44b1c5548c','345678','2014-03-19',7),(19,'Rene','Kembl','gghhdd@ukr.net',1,'2014-04-06 07:54:00','6ea0ee2308c4a05c25f20e03a794b893','987654','2014-04-04',8),(20,'German','Vouk','ole@olo.net',1,'2014-04-06 07:54:00','ec1a021693538176f8b17b591c7e8056','123456','2014-04-04',9),(21,'','','karen@gala.net',NULL,'2014-04-06 07:55:40','bcf831b25f16df78454a47ea56f989ea','931021','2014-04-04',10),(22,'','','bea@gala.net',1,'2014-04-06 07:54:02','925d53ca9fba03ac2761fd5469f56295','345678','2014-04-04',11),(23,'Ola','Kanonjere','ola@gala.net',1,'2014-04-06 07:54:02','3756dbf664808d3fbcbdd3a82657b3e0','123456','2014-04-04',12),(25,'','','mika@gala.net',NULL,'2014-04-06 07:51:44','22302d6f3411cd5e5b769257e6146743','123456','2014-04-04',13),(26,'','','raptor@ukr.net',1,'2014-04-06 07:54:05','58534d43cec18b521b9cfab47a2a70cc','123456','2014-04-06',14),(27,'','','kdsjflaksdjf@ukr.net',NULL,'2014-04-06 07:24:34','336d9876d8c2303c8d9d19427364bef8','123456','2014-04-06',15);
...
CREATE TABLE `manager_message` (
  ...
  CONSTRAINT `FK_manager_message_manager_id` FOREIGN KEY (`manager_id`) REFERENCES `manager` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `region` (
  ...
  KEY `FK_region_country_id_idx` (`country_id`,`locale_id`),
  CONSTRAINT `FK_region_country_id` FOREIGN KEY (`country_id`, `locale_id`) REFERENCES `country` (`id`, `locale_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_region_locale_id` FOREIGN KEY (`locale_id`) REFERENCES `locale` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `review` (
  ...
  CONSTRAINT `FK_rate_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_rate_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `review` VALUES (4,6,2,4,'Мені готель сподобався, але могло б бути краще.'),(5,6,8,5,'Найкращий готель з тих, де мені вдалося побувати');
...
CREATE TABLE `room` (
  ...
  CONSTRAINT `FK_room_hotel_id` FOREIGN KEY (`hotel_id`) REFERENCES `hotel` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `room_info` (
  ...
  CONSTRAINT `FK_room_info_locale_id` FOREIGN KEY (`locale_id`) REFERENCES `locale` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_room_info_room_id` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `service` (
  ...
  CONSTRAINT `FK_service_locale_id` FOREIGN KEY (`locale_id`) REFERENCES `locale` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `street` (
  ...
  KEY `FK_street_country_id_idx1` (`country_id`,`locale_id`),
  KEY `street_city` (`city_id`,`locale_id`),
  KEY `FK_street_region_id_idx` (`region_id`,`locale_id`),
  CONSTRAINT `FK_street_region_id` FOREIGN KEY (`region_id`, `locale_id`) REFERENCES `region` (`id`, `locale_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_street_city_id` FOREIGN KEY (`city_id`, `locale_id`) REFERENCES `city` (`id`, `locale_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_street_country_id` FOREIGN KEY (`country_id`, `locale_id`) REFERENCES `country` (`id`, `locale_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-04-06 10:56:33
