(function($) {
	commonBookingAjax = (function() {
		...
		return {
			...
			getRooms : function(data, handler) {
				var args = {
					name : 'book-room?action=getRooms',
					args : [ 'hotel_id', 'date_from', 'date_to' ]
				};
				var additional = {
					type : 'post',
					dataType: 'html'
			...
			book : function(data, handler) {
				var args = {
					name : 'book-room?action=book',
					args : [ 'hotel_id', 'date_from', 'date_to', 'totalCost',
							'rooms', 'name', 'surename', 'mail', 'phone']
				};
				var additional = {
					type : 'post',
					dataType: 'html'
